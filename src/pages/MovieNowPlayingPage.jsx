...
function MovieNowPlayingPage() {
  ...
  const { movies, loading, error, fetchMoviesNowPlaying } = useContext(MoviesContext);
                    ...
                    <div className="row">
                      ...
                      <div className="col-md-6 position-relative">
                        ...
                        <div className="movie-info-box py-4">
                          ...
                          <button onClick={() => navigate(`/movie/${movie.id}`)} className="btn btn-light text-secondary rounded-0 fw-bold get-ticket-btn">Get Ticket</button>
                        </div>
                      </div>
                    </div>
                  </div>
